...
export const crmAppConfig = {
  ...
  dataCoopAppUrl: normalizeOptional(import.meta.env.VITE_DATA_COOP_APP_URL) ?? '/data-coop',
  ecoStackAppUrl: normalizeOptional(import.meta.env.VITE_ECOSTACK_APP_URL) ?? '/eco-stack',
  remixAppUrl:
