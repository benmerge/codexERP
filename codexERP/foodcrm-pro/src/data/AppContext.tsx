...
export const AppProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const decorateOrderForStorage = (order: Order, dataId: string) => {
    ...
    return removeUndefined({
      ...
      salesRepId: customer?.salesRepId || order.salesRepId || currentRep?.id,
      salesRepName: customer?.salesRepName || order.salesRepName || currentRep?.displayName,
      salesRepEmail: customer?.salesRepEmail || order.salesRepEmail || currentRep?.email,
      items,
    });
  };
